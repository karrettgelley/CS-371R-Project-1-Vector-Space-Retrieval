...
public class FeedbackProx {
   ...
   */
  public InvertedIndexProx invertedIndex;
  /**
   ...
   */
  public FeedbackProx(HashMapVector queryVector, Retrieval[] retrievals, InvertedIndexProx invertedIndexProx) {
  ...
  public void getFeedback(int showNumber) {
    ...
    String response = UserInput
        .prompt("Is document #" + showNumber + ":" + docRef.file.getName() + " relevant (y:Yes, n:No, u:Unsure)?: ");
