...
public class Retrieval implements Comparable {
  ...
  /**
   * The score given to this document by a retrieval engine. Higher scores mean it
   ...
   * @return -1 if better than obj, 0 if same, 1 if worse than obj since this will
   *         produce a descending sort from best to worst.
   * @see java.util.Arrays#sort
   */
  public int compareTo(Object obj) {
    Retrieval retrieval = (Retrieval) obj;
    if (score / proxScore == retrieval.score / retrieval.proxScore)
      return 0;
    else if (score / proxScore > retrieval.score / retrieval.proxScore)
      return -1;
    else
      return 1;
  }
